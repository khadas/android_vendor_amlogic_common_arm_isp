...
static acam_reg_t linear_1080p_30fps_222Mbps_4lane_12bits[] = {
    ...
    {0xFFFF, 1},
    {0x3005, 0x01, 0x00, 1}, //0:10bit 1:12bit
    {0x3007, 0x00, 0x00, 1}, //full hd 1080p
    {0x3009, 0x12, 0x00, 1},
    {0x300A, 0xF0, 0x00, 1}, //black level
    {0x300B, 0x00, 0x00, 1},
    ...
    {0x3014, 0x20, 0x00, 1},//Gain
    {0x3016, 0x09, 0x00, 1},

    {0x3018, 0x65, 0x00, 1}, /* VMAX[7:0] */
    {0x3019, 0x04, 0x00, 1}, /* VMAX[15:8] */
    {0x301a, 0x00, 0x00, 1}, /* VMAX[16] */

    {0x301b, 0x00, 0x00, 1},

    {0x301c, 0x30, 0x00, 1}, /* HMAX[7:0] */
    {0x301d, 0x11, 0x00, 1}, /* HMAX[15:8] */

    {0x3020, 0x01, 0x00, 1},//SHS1
    {0x3021, 0x00, 0x00, 1},

    {0x3046, 0x01, 0x00, 1},//LANE CHN
    ...
    {0x315E, 0x1A, 0x00, 1},// 1A:37.125MHz 1B:74.25MHz
    {0x3164, 0x1A, 0x00, 1},// 1A:37.125MHz 1B:74.25MHz
    ...
    {0x3442, 0x0C, 0x00, 1},
    {0x3443, 0x03, 0x00, 1},
    {0x3444, 0x20, 0x00, 1},//mclk :37.125M
    {0x3445, 0x25, 0x00, 1},

    {0x3446, 0x47, 0x00, 1},//global timming
    {0x3447, 0x00, 0x00, 1},
    {0x3448, 0x1F, 0x00, 1},
    {0x3449, 0x00, 0x00, 1},
    {0x344A, 0x17, 0x00, 1},

...
static uint32_t _calibration_ae_control[] = {
    30,  // AE convergance
    178, // LDR AE target -> this should match the 18% grey of teh output gamma
    0,   // AE tail weight
...
static uint16_t _calibration_ae_zone_wght_hor[] = {0, 0, 0, 0, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 0, 0, 0, 0};
static uint16_t _calibration_ae_zone_wght_ver[] = {0, 0, 0, 0, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 0, 0, 0, 0};

...
#ifndef __AML_P1_CSIPHY_H__
#define __AML_P1_CSIPHY_H__
...
struct csiphy_dev_ops {
	void (*hw_reset)(void *c_dev);
	u32 (*hw_version)(void *c_dev);
	int (*hw_start)(void *c_dev, int lanes, s64 link_freq);
	void (*hw_stop)(void *c_dev);
};

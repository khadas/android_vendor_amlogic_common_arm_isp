...
//	int rgb2yuv_matrix[9] = { 77, 150, 29,  -43, -85,  128,  128, -107, -21 };
    ...
    prm_common->reg_axi_mode  = 0;              //u2, 0:always axi_addr, 1: axi_addr-axi_addrp pingpong, 2~3:buffer_mode, start with axi_addr
    prm_common->reg_axi_buff_rst  = 4;          //u1, frame buffer reset
    prm_common->reg_axi_fbuf   = 4096;          //u29, axi_buffer size
                                                //end
                                                //REG_NAME: ISP_MD2AXI_FRAMESIZE
                                                //u3, reserved
    prm_common->reg_axi_fsize  = 4096;          //u29, axi_fsize
                                                //end
                                                //REG_NAME: ISP_MD2AXI_ADDR
    prm_common->reg_axi_addr  = (unsigned int)paddr_md;//268435456;      //u32, axi_addr
                                                //end
                                                //REG_NAME: ISP_MD2AXI_ADDRP
    prm_common->reg_axi_addrp  = (unsigned int)paddr_md;//268435456;      //u32, axi_addrp
                                                //end
	...
	prm_common->reg_md2_win_xxyy_2 = 0;                //u14
	                                                //u2
	prm_common->reg_md2_win_xxyy_3 = ysize;              //u14
	                                                //end

	                                                //REG_NAME: MD2_PRE_STEP_NORM
                                                 //u7
	prm_common->reg_md2_preds_hstp = 3;              //u5, integer pixel ratio for pre horizontal shrink, o2i_ratio= 1/step, 1~31
...
//}
   // return 0;
    ...
    prm_common->reg_md2_preds_hstp = 4;

...
typedef enum {
    ...
    FSM_PARAM_SET_SENSOR_MODE_SWITCH,
    FSM_PARAM_SET_SENSOR_VMAX_FPS,
    FSM_PARAM_SET_SENSOR_POWER_ON,
    FSM_PARAM_SET_SENSOR_POWER_OFF,
    FSM_PARAM_SET_SENSOR_MD_EN,
    FSM_PARAM_SET_SENSOR_DECMPR_EN,
    FSM_PARAM_SET_SENSOR_FLICKER_EN,
    FSM_PARAM_SET_SENSOR_DECMPR_LOSSLESS_EN,
    ...
    FSM_PARAM_SET_SNR_MANUAL,
    FSM_PARAM_SET_SNR_STRENGTH,
    FSM_PARAM_SET_TNR_MANUAL,
    FSM_PARAM_SET_TNR_OFFSET,
    FSM_PARAM_SET_TNR_MD_LEVEL,
    FSM_PARAM_SET_TNR_MD_MTN,
	...
	/* AUTOCAP */
	FSM_PARAM_SET_AUTOCAP_START,
	FSM_PARAM_SET_AUTOCAP_FR_ADDR,
	FSM_PARAM_SET_AUTOCAP_DS1_ADDR,
	FSM_PARAM_SET_AUTOCAP_HW_RESET,
	FSM_PARAM_SET_AUTOCAP_END,
...
typedef enum {
    ...
    FSM_PARAM_GET_SNR_MANUAL,
    FSM_PARAM_GET_SNR_STRENGTH,
    FSM_PARAM_GET_TNR_MANUAL,
    FSM_PARAM_GET_TNR_OFFSET,
    FSM_PARAM_GET_TNR_MD_MODE,
    FSM_PARAM_GET_TNR_MD_THRD1,
    FSM_PARAM_GET_TNR_MD_THRD2,
    FSM_PARAM_GET_TNR_MD_LOG,

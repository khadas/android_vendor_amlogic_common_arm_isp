...
extern void am_sc1_api_dma_buffer(tframe_t * data, unsigned int index);
extern uint32_t am_sc1_get_width(void);
extern void am_sc1_set_width(uint32_t src_w, uint32_t out_w);
extern uint32_t am_sc1_get_height(void);
uint32_t am_sc1_get_output_format(void);
extern void am_sc1_set_height(uint32_t src_h, uint32_t out_h);
extern void am_sc1_set_input_format(uint32_t value);
extern void am_sc1_set_output_format(uint32_t value);
extern void am_sc1_set_buf_num(uint32_t num);
extern int am_sc1_set_callback(acamera_context_ptr_t p_ctx, buffer_callback_t sc1_callback);
extern int am_sc1_system_init(void);
extern int am_sc1_hw_init(int is_print, int clip_mode);
extern int am_sc1_start(void);
extern int am_sc1_reset(void);
extern int am_sc1_stop(void);
extern int am_sc1_system_deinit(void);
extern int am_sc1_hw_deinit(void);
extern uint32_t am_sc1_get_startx(void);
extern uint32_t am_sc1_get_starty(void);
extern void am_sc1_set_fps(uint32_t c_fps, uint32_t t_fps);
extern uint32_t am_sc1_get_fps(void);
extern void am_sc1_set_startx(uint32_t startx);
extern void am_sc1_set_starty(uint32_t starty);
extern uint32_t am_sc1_get_crop_width(void);
extern uint32_t am_sc1_get_crop_height(void);
extern void am_sc1_set_crop_width(uint32_t c_width);
extern void am_sc1_set_crop_height(uint32_t c_height);
extern void am_sc1_set_src_width(uint32_t src_w);
extern void am_sc1_set_src_height(uint32_t src_h);
void am_sc1_set_crop_enable(void);

...
#if PLATFORM_G12B || PLATFORM_C308X || PLATFORM_T7
#define FW_USE_AML_DMA    0
#endif
...
#define FSM_NAMES {"GENERIC","SENSOR","CMOS","CROP","GENERAL","AE_MANUAL","AWB_MANUAL","COLOR_MATRIX","IRIDIX8_MANUAL","NOISE_REDUCTION","SHARPENING","MATRIX_YUV","GAMMA_MANUAL","MONITOR","SBUF","DMA_WRITER","METADATA","AF_MANUAL","AUTO_CAP"}
#ifdef CONFIG_SEAMLESS_N
#define FW_DO_INITIALIZATION 1
#endif
#ifdef CONFIG_SEAMLESS_Y
#define FW_DO_INITIALIZATION 0
#endif
...
#define IRIDIX_STRENGTH_TARGET 13708
...
#define ISP_HAS_SC0 1
#define ISP_HAS_SC1 1
#define ISP_HAS_SC2 1
#define ISP_HAS_SC3 1

#define ISP_HAS_FLICKER 0
#define ISP_HAS_CMPR    0
#define ISP_HAS_MD      0
...
#define ISP_IRQ_MASK_VECTOR 4289199090UL
...
#define LOG_MODULE_AUTOCAPTURE 18
...
#define ACAMERA_CALIBRATION_OTP 0
#define ACAMERA_CALIBRATION_LOAD_EXTERFILE 0
extern unsigned int g_firmware_context_number;
#endif

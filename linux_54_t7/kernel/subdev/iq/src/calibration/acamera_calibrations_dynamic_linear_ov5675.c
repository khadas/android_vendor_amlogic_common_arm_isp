...
static uint32_t _calibration_custom_settings_context[][4] = {
    ...
    //Demosaic
    { 0x1ae7c, 0xb4a0c8c8L, 0xffffffff,4 }, // UU Slope/VA Slope/AA Slope/VH Slope
    { 0x1ae84, 0x07800f0L, 0xfff0fff,4 }, //AA Thresh/VH Thresh
    { 0x1ae88, 0x15e00faL, 0xfff0fff,4 }, //UU Thresh/VA Thresh
    { 0x1ae90, 0x2bc02bcL, 0xfff0fff,4 }, //AA Offset/VH Offset
    { 0x1ae94, 0x0384L, 0xfff0fff,4 }, //UU Offset/VA Offset
    { 0x1aec0, 0x80adcL, 0xffffff,4 }, //grey det thresh/lg det thresh/UU SH Slope
    { 0x1aec8, 0x3a9806a4L, 0xffffffff,4 }, //grey det slope/lg det slope
